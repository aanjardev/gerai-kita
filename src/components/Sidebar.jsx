...
// --- KUMPULAN IKON SVG SEBAGAI KOMPONEN REACT (SAMA SEPERTI DI BOTTOMNAVBAR) ---
// Untuk menghindari duplikasi kode, idealnya file ikon ini dibuat terpisah,
// tapi untuk kecepatan, kita copy-paste saja.
...
// (Silakan copy-paste kode SVG lengkap dari file BottomNavBar.jsx ke sini)
...
function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      <h2 className="sidebar-brand">GeraiKita Seller</h2>
      <nav className="sidebar-nav">
        <NavLink to="/dashboard" end>
          <HomeIcon />
          <span>Beranda</span>
        </NavLink>
        <NavLink to="/dashboard/produk">
          <ProductIcon />
          <span>Produk</span>
        </NavLink>
        <NavLink to="/dashboard/promosi">
          <PromotionIcon />
          <span>Promosi</span>
        </NavLink>
